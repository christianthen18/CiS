...
@section('content')
    <div class="container mt-5">
        <h2 class="text-center mb-4">Sales Return Details - Invoice Number: {{ $retur->invoice_number }}</h2>

        <div class="card shadow-sm">
            <div class="card-body">
                <h5><strong>Customer:</strong> {{ $retur->customer->name }}</h5>
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('salesRetur.index') }}" class="btn btn-info">Back to Returns</a>
                </div>
            </div>
        </div>
    </div>
